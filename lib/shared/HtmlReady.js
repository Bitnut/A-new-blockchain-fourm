...
exports.default = function (html) {
    ...
    try {
        ...
        // xmldom error is bad
        console.log('rendering error', (0, _stringify2.default)({ error: error.message, html: html }));
        return { html: '' };
    }
};
...
function proxifyImages(doc) {
    ...
    [].concat((0, _toConsumableArray3.default)(doc.getElementsByTagName('img'))).forEach(function (node) {
        ...
        if (!_Links2.default.local.test(url)) node.setAttribute('src', (0, _ProxifyUrl2.default)(url, true));
    });
}
...
//# sourceMappingURL=HtmlReady.js.map