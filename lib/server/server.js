...
var _account_recovery = require('./api/account_recovery');

var _account_recovery2 = _interopRequireDefault(_account_recovery);

var _enter_confirm_email = require('./sign_up_pages/enter_confirm_email');

var _enter_confirm_email2 = _interopRequireDefault(_enter_confirm_email);

var _enter_confirm_mobile = require('./sign_up_pages/enter_confirm_mobile');

var _enter_confirm_mobile2 = _interopRequireDefault(_enter_confirm_mobile);
...
var _PinnedPosts = require('./utils/PinnedPosts');
...
app.use((0, _koaMount2.default)('/robots.txt', /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
...
(0, _enter_confirm_email2.default)(app);
(0, _enter_confirm_mobile2.default)(app);
(0, _user_json2.default)(app);
(0, _post_json2.default)(app);

(0, _account_recovery2.default)(app);
(0, _general2.default)(app);

app.use( /*#__PURE__*/_regenerator2.default.mark(function _callee5(next) {
    return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
            switch (_context5.prev = _context5.next) {
                case 0:
                    this.adsEnabled = !(this.session.auth || this.session.a) && _config2.default.google_ad_enabled;
                    _context5.next = 3;
                    return next;
...
if (env === 'production') {
    ...
    if (!helmetConfig.directives.frameSrc) {
        helmetConfig.directives.frameSrc = ['\'self\'', 'googleads.g.doubleclick.net', 'https:'];
    }
            ...
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        ...
                        ['content-security-policy', 'x-content-security-policy', 'x-webkit-csp'].forEach(function (header) {
                            var policy = _this2.response.header[header].split(/;\s+/).map(function (el) {
                                if (el.startsWith('script-src')) {
                                    var oldScriptSrc = el.replace(/^script-src/, '');
                                    return 'script-src \'unsafe-inline\' \'unsafe-eval\' data: https: ' + oldScriptSrc;
                                } else {
                                    return el;
                                }
                            }).join('; ');
                            _this2.response.set(header, policy);
                        });
                        _context6.next = 4;
                        return next;
...
if (env !== 'test') {
    ...
    app.pinnedPostsPromise = (0, _PinnedPosts.pinnedPosts)();
    app.use( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
        var bot;
