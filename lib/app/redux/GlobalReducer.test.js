...
describe('Global reducer', function () {
    ...
    it('should return correct state for a UPDATE_ACCOUNT_WITNESS_VOTE action', function () {
        // Arrange
        var payload = {
            account: 'Smee',
            witness: 'Greech',
        ...
        var initial = (0, globalActions.default)();
        // Act
        var actual = (0, globalActions.default)(initial, globalActions.updateAccountWitnessVote(payload));
        // Assert
        expect(actual.getIn(['accounts', payload.account, 'witness_votes'])).toEqual((0, _immutable.Set)([payload.witness]));
        // Arrange
        payload.approve = false;
        // Act
        actual = (0, globalActions.default)(initial, globalActions.updateAccountWitnessVote(payload));
        // Assert
        expect(actual).toEqual(initial);
    });
    it('should return correct state for a UPDATE_ACCOUNT_WITNESS_PROXY action', function () {
        // Arrange
        var payload = {
            account: 'Alice',
            proxy: 'Jane'
        ...
        var initial = (0, globalActions.default)();
        var expected = (0, _immutable.Map)({ proxy: payload.proxy });
        // Act
        var actual = (0, globalActions.default)(initial, globalActions.updateAccountWitnessProxy(payload));
        // Assert
...
//# sourceMappingURL=GlobalReducer.test.js.map