...
function accountAuthLookup(_ref) {
    ...
    var stateUser, keys, toPub, posting, active, memo, auth, accountName, pub_keys_used;
        ...
        while (1) {
            switch (_context.prev = _context.next) {
                ...
                case 28:
                    ...
                    _context.t4 = account.get('memo_key') === toPub(memo) ? 'full' : 'none';
                    auth = {
                        posting: _context.t1,
                        active: _context.t3,
                        owner: 'none',
