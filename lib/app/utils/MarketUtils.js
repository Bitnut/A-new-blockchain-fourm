...
function roundUp(num, precision) {
    var satoshis = parseFloat(num) * Math.pow(10, precision);
 ...
 */
var createOrderSorter = function createOrderSorter(getValue, columnName, dir) {
    return function (a, b) {
...
module.exports = {
    roundUp: roundUp,
    roundDown: roundDown,
    createOrderSorter: createOrderSorter
};
