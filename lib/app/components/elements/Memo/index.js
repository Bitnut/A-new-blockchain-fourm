        ...
        value: function render() {
            ...
            if (isFromBadActor && !this.state.revealMemo) {
                renderText = _react2.default.createElement(
                    'div',
                    { className: 'bad-actor-warning' },
                    _react2.default.createElement(
                        'div',
                        { className: 'bad-actor-caution' },
                        (0, _counterpart2.default)('transferhistoryrow_jsx.bad_actor_caution')
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'bad-actor-explained' },
                        (0, _counterpart2.default)('transferhistoryrow_jsx.bad_actor_explained')
                    ),
                    _react2.default.createElement(
                        'div',
                        {
                        ...
                        (0, _counterpart2.default)('transferhistoryrow_jsx.bad_actor_reveal_memo')
                    )
                );
            } else if (fromNegativeRepUser && !this.state.revealMemo) {
                renderText = _react2.default.createElement(
                    'div',
                    { className: 'from-negative-rep-user-warning' },
                    _react2.default.createElement(
                        'div',
                        { className: 'from-negative-rep-user-caution' },
                        (0, _counterpart2.default)('transferhistoryrow_jsx.from_negative_rep_user_caution')
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'from-negative-rep-user-explained' },
                        (0, _counterpart2.default)('transferhistoryrow_jsx.from_negative_rep_user_explained')
                    ),
                    _react2.default.createElement(
                        'div',
                        {
                        ...
                        (0, _counterpart2.default)('transferhistoryrow_jsx.from_negative_rep_user_reveal_memo')
                    )
                );
            }
