...
var Notice = function Notice(_ref) {
    ...
    var url = notice.permalink ? '/@' + notice.author + '/' + notice.permlink : notice.url;
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                notices.map(function (notice) {
                    return _react2.default.createElement(Notice, { key: notice.title, notice: notice });
                })
            )
        )
    );
...
exports.default = SteemitNotices;
