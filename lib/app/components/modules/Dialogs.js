...
var _ConvertToSteem = require('app/components/elements/ConvertToSteem');

var _ConvertToSteem2 = _interopRequireDefault(_ConvertToSteem);

var _SuggestPassword = require('app/components/elements/SuggestPassword');

var _SuggestPassword2 = _interopRequireDefault(_SuggestPassword);
...
var _QrKeyView = require('app/components/elements/QrKeyView');

var _QrKeyView2 = _interopRequireDefault(_QrKeyView);
    ...
    (0, _createClass3.default)(Dialogs, [{
        ...
        value: function render() {
            ...
            var dialogs = active_dialogs.reduce(function (r, v, k) {
                ...
                ) : k === 'convertToSteem' ? _react2.default.createElement(
                    'span',
                    { key: idx++ },
                    _react2.default.createElement(
                        _Reveal2.default,
                        ...
                        _react2.default.createElement(_CloseButton2.default, { onClick: _this3['hide_' + k] }),
                        _react2.default.createElement(_ConvertToSteem2.default, { onClose: _this3['hide_' + k] })
                    )
                ) : k === 'suggestPassword' ? _react2.default.createElement(
                    'span',
                    { key: idx++ },
                    _react2.default.createElement(
                        _Reveal2.default,
                        { onHide: _this3['hide_' + k], show: true, size: 'medium' },
                        _react2.default.createElement(_CloseButton2.default, { onClick: _this3['hide_' + k] }),
                        _react2.default.createElement(_SuggestPassword2.default, { onClose: _this3['hide_' + k] })
                    )
                ) : k === 'changePassword' ? _react2.default.createElement(
                    'span',
                    { key: idx++ },
                    _react2.default.createElement(
                        _Reveal2.default,
                        ...
                        _react2.default.createElement(_CloseButton2.default, { onClick: _this3['hide_' + k] }),
                        _react2.default.createElement(_ChangePassword2.default, (0, _extends3.default)({
                            onClose: _this3['hide_' + k]
                        }, v.get('params').toJS()))
                    )
                ...
                ) : k === 'qr_key' ? _react2.default.createElement(
                    'span',
                    { key: idx++ },
                    _react2.default.createElement(
                        _Reveal2.default,
                        { onHide: _this3['hide_' + k], show: true },
                        _react2.default.createElement(_CloseButton2.default, { onClick: _this3['hide_' + k] }),
                        _react2.default.createElement(_QrKeyView2.default, (0, _extends3.default)({
                            onClose: _this3['hide_' + k]
                        }, v.get('params').toJS()))
                    )
                ) : null;
